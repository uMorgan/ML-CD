...
MODELS = {
    ...
    "A2C": (A2C, os.path.join(SCRIPT_DIR, "models/a2c_lunarlander_checkpoints/lunarlander_model_{}_steps")),
    "PPO": (PPO, os.path.join(SCRIPT_DIR, "models/ppo_lunarlander_checkpoints/lunarlander_model_{}_steps"))
}
